...
TEST_F(ReconnectManagerTest, InitialStateIsDisconnected) { EXPECT_EQ(rm_->state(), State::DISCONNECTED); }
...
{
  ros::init(argc, argv, "test_reconnect_manager", ros::init_options::AnonymousName);
  ros::Time::init();
